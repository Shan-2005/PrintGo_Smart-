    ...
    <div className="flex flex-col gap-10">
      <div className="max-w-xl">
        <motion.h2
          ...
          className="text-4xl lg:text-5xl font-google-sans font-bold text-[#1a1c1e] leading-tight"
        >
          Ready to <span className="text-[#005fb0]">print?</span>
        </motion.h2>
        <p className="text-lg lg:text-xl text-[#44474e] mt-2 lg:mt-4 font-medium opacity-80">
